...
mu_proposal <- rnorm(mu_current, sqrt(proposal_width)) 
# 15 proposal samples 
rnorm(15,mu_proposal,sqrt(proposal_width))
...
likelihood_current <- rnorm(1,mu_current,sqrt(proposal_width))*
  (approxfun(density(y))(y)) #linear interpolation of probabilities at data points
