...
```{r}
table(mice$Diet) #chow 12, hf 12
#beta_mat <- matrix(1, nrow=2,ncol=12) #for each beta_0 in chow and each beta_1 in hf


solve(crossprod(A)) %*% t(A)



lm(y~x[,2]) #intercept = 23.8, x[,2] = 3.0 
