...
modVol.coda <- coda.samples(mod.vol,
                        ...
                        variable.names = c("a0.raw", "b0.raw", "a0", "b0", "a_terr", "b_terr", "sigma.terr.int", "sigma.terr.slope", "a_terr.raw", "b_terr.raw"),
                        n.iter = 40000)
```

```{r Plots and Summaries}
# Convergence tests:
traceplot(modVol.coda, col = c("red", "green", "blue")) # we can see immediately from these that there was no convergence, but another option is the Gelman plot:
